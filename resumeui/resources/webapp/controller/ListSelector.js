sap.ui.define([
		...
		return BaseObject.extend("resumedb.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias resumedb.model.ListSelector
			 */
			 ...
			 * @return {resumedb.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
