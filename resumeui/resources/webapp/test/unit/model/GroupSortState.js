sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("sub_area").length, 1, "The sorting by sub_area returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by sub_area and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("sub_area");
