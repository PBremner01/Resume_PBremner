							...
							success : function (aEntitySet) {
								...
								return this.waitFor({
									...
									check: function (oList) {
										...
										var sObjectID = oList.getBindingContext().getProperty("sub_area");

										var iLength = aEntitySet.filter(function (oLineItem) {
											return oLineItem.sub_area === sObjectID;
										}).length;
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								return this.waitFor({
									id : "lineItemsHeader",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name: "text", value: "Subjects (" + iNumberOfItems + ")"}),
									success : function () {
